...
urlpatterns = [
    ...
    #################文档相关
    path('project-<int:pro_id>/doc-<int:doc_id>/', views.doc_index, name='doc'),  # 文档浏览页
    path('doc/<int:doc_id>/', views.doc_index, name="doc_id"),  # 文档浏览页(通过文档ID)
    ...
    path('import/word/project/', views_import.import_word_project, name='import_word_project'), # 导入Word文集
    #################文档分享相关
